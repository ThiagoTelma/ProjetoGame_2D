					    ...
					    if (CenaDoJogo.cenario.getCenaValida().equals(CenaDoJogo.indio.cenario) && 
					        ...
					        if (resposta == javax.swing.JOptionPane.YES_OPTION) {
					            if (CenaDoJogo.Jogador.moedas >= 2) {
					                ...
					                javax.swing.JOptionPane.showMessageDialog(CenaDoJogo, "Troca realizada com sucesso!");
					            } else {
					                javax.swing.JOptionPane.showMessageDialog(CenaDoJogo, "Voce nao possui moedas suficientes!");
					            }
					        }
					    }
